		...
		<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
		  ...
		  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
		    <ul class="navbar-nav mr-auto">
		      ...
		      <li class="nav-item " id="categorias">
		        <a class="nav-link " href="categorias.php" tabindex="-1" aria-disabled="true">Categorias</a>
		      </li>
		   	  <li class="nav-item" id="productos">
		        <a class="nav-link " href="#" tabindex="-1" aria-disabled="true">Productos o servicios</a>
		      </li>
		      <li class="nav-item" id="denuncias">
		        <a class="nav-link " href="denuncias.php" tabindex="-1" aria-disabled="true">Denuncias</a>
		      </li>
		      <li class="nav-item" id="reportes">
		    ...
		    <form class="form-inline my-2 my-lg-0">
		      <button class="btn btn-outline-success my-2 my-sm-0" type="submit"><i class="fas fa-user fa-lg"></i>&nbsp;&nbsp;Perfil</button>
...
>>>>>>> 46a96325d35f93b4b6cd349fa8503bb66104c387
</html>