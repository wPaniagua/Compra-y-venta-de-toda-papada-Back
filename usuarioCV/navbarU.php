	...
	<div class="fixed-top">
		<nav class="navbar navbar-expand-md navbar-dark fixed-top navbarP" style="background-color: #EA1D5D">
		  ...
		  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
		    <ul class="navbar-nav mr-auto">
			  ...
			  <li class="nav-item " id="favoritos">
		        <a class="nav-link  font-weight-bold" href="#" tabindex="-1" aria-disabled="true">Favoritos</a>
		      </li>
		    </ul>
  		...
  		<a href="#" class=""><i class="fas fa-user-circle  fa-3x" style="color:#212529;display:none" id="iconU"></i>
		    		<div id="imgNP" ></div></a>
		  <a href="#" class="dropdown-toggle dropdown-toggle-split " data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="padding-right: 80px;padding-top: 15px;color:#212529;font-size:20px;">
		    <span class="sr-only">Toggle Dropdown</span>
		  </a>
		  <div class="dropdown-menu">
		    <a class="dropdown-item" href="http://localhost/Compra-y-venta-de-toda-papada-Back/usuarioCV/perfil.php">Editar Perfil</a>
