...
case 'obtenerAnuncio':
    ...
    $mysqli->multi_query("SET @p0=''; SET @p1=''; SET @p2=''; SET @p3=''; SET @p4=''; SET @p5=''; SET @p6=''; SET @p7=''; SET @p8=''; SET @p9='obtenerAnuncio'; CALL ` SP_AGREGAR_PUB`(@p0, @p1, @p2, @p3, @p4, @p5, @p6, @p7, @p8, @p9, @p10);");
    $resultadoConsulta = array();
    do {
        if ($resultado = $mysqli->store_result()) {
          while ($fila = $resultado->fetch_assoc()) {
